...
public class RMIServerImpl extends UnicastRemoteObject implements RMIServer,
	...
	public void startRMIServer() {
		...
		if (System.getSecurityManager() == null) {
			...
			if (currentDir.contains(" ")) {
				dispatchMessage("Error: Your current working directory is \n --" + currentDir + 
						"\nPlease make sure there are no spaces in any of the folder names");
			}
	...
	private String getRegistryDetails() {
		...
		try {
			...
			registryDetails += "Error: Wrong url syntax: " + serverOptions.getRMIAddress() + "\n";
			e.printStackTrace();
			return registryDetails;
		} catch (RemoteException e) {
